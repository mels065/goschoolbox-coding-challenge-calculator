...
const performDecimalMath = (operand1, operator, operand2) => {
    ...
    if (operator !== '^') {
        ...
        const numOfFractionalPartsSize1 = numOfFractionalParts1 ? numOfFractionalParts1[1].length : 0;
        const numOfFractionalPartsSize2 = numOfFractionalParts2 ? numOfFractionalParts2[1].length : 0;
